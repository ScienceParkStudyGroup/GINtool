...
namespace GINtool
{
    class EnrichmentAnalysis
    {
        ...
        public Excel.Shape DrawDistributionPlot(HashSet<string> aRegulons, SysData.DataTable aTable)
        {
            if (theApp == null)
                return null;
        ...
        public Excel.Shape DrawQPlot(HashSet<string> aRegulons, SysData.DataTable aTable)
        {
            ...
            qPlot.Palette = (ChartColorPalette)Properties.Settings.Default.defaultPalette;

            return CreateEmfShape(qPlot, hWnd, theApp);

        }

        public Excel.Shape DrawEnrichmentChart(HashSet<string> aRegulons, SysData.DataTable aTable)
        {
            if (theApp == null)
                return null;
